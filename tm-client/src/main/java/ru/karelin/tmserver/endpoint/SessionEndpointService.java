 ...
 * 2019-04-22T15:27:35.257+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SessionEndpointService",
                  wsdlLocation = "http://cluster/SessionEndpoint?wsdl",
                  targetNamespace = "http://endpoint.tmserver.karelin.ru/")
public class SessionEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tmserver.karelin.ru/", "SessionEndpointService");
    public final static QName SessionEndpointPort = new QName("http://endpoint.tmserver.karelin.ru/", "SessionEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://cluster/SessionEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SessionEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://cluster/SessionEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
